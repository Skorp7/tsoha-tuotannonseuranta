...
def add(order_type_id, customer_id, delivery_date, clinic_id):
    try:
        sql = "INSERT INTO orders (order_type_id, customer_id, clinic_id, delivery_date, time, in_progress) VALUES (:order_type_id, :customer_id, :clinic_id, :delivery_date, LOCALTIMESTAMP, 1) RETURNING id"
